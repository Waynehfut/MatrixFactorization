...
def update_university_latlng():
    sql1 = "select id,university from university_list where id > '252' "
...
def update_university_hos_duration():
    ...
    # f = log.get_log()
    sql1 = "select university,latlng from university_list where id >= '261' and id <= '275' "
...
if __name__ == '__main__':
    ...
    update_university_hos_duration()#253-275
